...
const ListType: React.FC<ProductTypeProps> = ({options}) => {
  ...
  return (
    <Link href={`/product/${id}`}>
        <div className='flex shadow-custom rounded-md  transition ease-in-out duration-500 hover:scale-[1.01] relative'>
            <div className="ribbon">
                <span> 
                    {discount}% OFF 
                </span>
            </div>
            <div className='relative h-[200px] w-1/2 z-[2]'>
                <Image
            ...
            <div className='flex flex-col justify-between w-1/2 p-2 space-y-1'>
